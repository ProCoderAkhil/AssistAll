...
const AppLoader = () => {
  ...
  // ✅ FIX: Used 'Cpu' (imported) instead of 'Power' (which was undefined/crashing)
  const loadingSteps = [
  ...
  // Helper to safely get the current icon
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="w-80 text-center space-y-6">
            ...
            <div className="h-10 flex items-center justify-center gap-3 text-green-400/80 font-mono text-xs font-bold tracking-widest uppercase animate-pulse">
                <CurrentIcon size={14} />
                {loadingSteps[Math.min(currentStep, loadingSteps.length - 1)].text}
            </div>
